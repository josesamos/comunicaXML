...
obtener_hoja_calculo <- function(archivo) {
  ...
  if (extension == "xlsx") {
    hoja_calculo <- system.file("extdata", "partes_viajeros_template.xlsx", package = "comunicaXML")
  } else if (extension == "ods") {
    hoja_calculo <- system.file("extdata", "partes_viajeros_template.ods", package = "comunicaXML")
  } else {
